...
test('JLinq.SelectMany.Test.3', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id === 4).SelectMany(x => x.lst).Select(function (x) { return { mapId: x }; });
...
test('JLinq.GroupBy.Test.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.GroupBy(x => x.GroupByKey);
...
test('JLinq.GroupBy.ChainTest.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).GroupBy(function (x) { return { key1: x.GroupByKey, key2: x.GroupByKey2 }; });
...
test('JLinq.Where.ChainTest.1', function () {
    ...
    //go build the query
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id === 1 || x.Id === 2).Take(1).ToArray();
...
test('JLinq.Where.ChainTest.2', function () {
    ...
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Take(5).Where(x => x.Id === 1 || x.Id === 2).ToArray();
...
test('JLinq.ConcatQuery.TestOffOfQueryWithQuery.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id === 1).Concat(UnitTestFramework.BuildArray(2).Where(x => x.Id === 1));
...
test('JLinq.ConcatQuery.TestOffOfQueryWithQuery.2', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).Concat(UnitTestFramework.BuildArray(2).Where(x => x.Id === 1)).Where(x => x.Id === 4);
...
test('JLinq.ConcatQuery.TestOffOfArrayWithQuery.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Concat(UnitTestFramework.BuildArray(2).Where(x => x.Id === 1));
...
test('JLinq.UnionQuery.TestOffOfQueryWithQuery.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id === 1).Select(x => x.Id).Union(UnitTestFramework.BuildArray(2).Select(x => x.Id));
...
test('JLinq.UnionQuery.TestOffOfArrayWithQuery.1', function () {
    ...
    //go build the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Select(x => x.Id).ToArray().Union(UnitTestFramework.BuildArray(2).Where(x => x.Id === 1).Select(x => x.Id));
...
test('JLinq.First.Test.1', function () {
    ...
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.First(x => x.Id === 1);
...
test('JLinq.First.Test.2', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.First(x => x.Id === 2);
...
test('JLinq.First.Test.3', function () {
    ...
    throws(function () {
        ...
        UnitTestFramework._MutableArrayTest.First(function (x) { return <any>x.Id === 'test'; });
...
test('JLinq.First.TestWithNoPredicate.2', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Where(x => x.Id === -9999).First();
    }, "Can't Find First Item. Query Returned 0 Rows");
});
...
test('JLinq.First.ChainTest.1', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 2).First(x => x.Id === 3);
...
test('JLinq.First.ResetIteratorTest.1', function () {
    ...
    var baseQuery = UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 1);
...
test('JLinq.FirstOrDefault.Test.1', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.FirstOrDefault(x => x.Id === 1);
...
test('JLinq.FirstOrDefault.Test.2', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.FirstOrDefault(x => x.Id === 2);
...
test('JLinq.FirstOrDefault.Test.3', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.FirstOrDefault(function (x) { return <any>x.Id === 'test'; });
...
test('JLinq.FirstOrDefault.TestWithNoPredicate.2', function () {
    ...
    //run it with no predicate
    equal(true, UnitTestFramework._MutableArrayTest.Where(x => x.Id === -9999).FirstOrDefault() == null);
});
...
test('JLinq.FirstOrDefault.ChainTest.1', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 2).FirstOrDefault(x => x.Id === 3);
...
test('JLinq.Single.Test.1', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Single(x => x.Id === 1);
...
test('JLinq.Single.Test.2', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Single(x => x.Id === 200);
...
test('JLinq.Single.Test.3', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Single(x => x.Id === 2 || x.Id === 3);
    }, "Can't Find A Single Item.Query Returned 0 Rows");
...
test('JLinq.Single.Test.4', function () {
    ...
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).Single(x => x.Id === 3);
...
test('JLinq.Single.Test.5', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).Single(x => x.Id === 3 || x.Id === 4);
...
test('JLinq.Single.TestWithNoPredicate.3', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Where(x => x.Id === -9999).Single();
    }, 'We Already Have A Match. Single Must Only Have 1 or 0 Items Returned. Use FirstOrDefault If You Are Expecting Multiple Items And Just Want To Grab The First Item');
});
...
test('JLinq.SingleOrDefault.Test.1', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.SingleOrDefault(x => x.Id === 1);
...
test('JLinq.SingleOrDefault.Test.2', function () {
    ...
    //go materialize the results.
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.SingleOrDefault(x => x.Id === 200);
...
test('JLinq.SingleOrDefault.Test.3', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.SingleOrDefault(x => x.Id === 2 || x.Id === 3);
...
test('JLinq.SingleOrDefault.Test.4', function () {
    ...
    //check that it chains correctly
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).SingleOrDefault(x => x.Id === 3);
...
test('JLinq.SingleOrDefault.Test.5', function () {
    ...
    throws(function () {
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).SingleOrDefault(x => x.Id === 3 || x.Id === 4);
    }, 'We Already Have A Match. SingleOrDefault Must Only Have 1 or 0 Items Returned. Use FirstOrDefault If You Are Expecting Multiple Items And Just Want To Grab The First Item');
});
...
test('JLinq.SingleOrDefault.TestWithNoPredicate.3', function () {
    ...
    //run it with no predicate
    equal(true, UnitTestFramework._MutableArrayTest.Where(x => x.Id === -9999).SingleOrDefault() == null);
});
...
test('JLinq.All.Test.1', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.All(x => x.Id < 100), true);
});
...
test('JLinq.All.Test.1', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.All(x => x.Id === 2), false);
});
...
test('JLinq.All.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id === 2).All(x => x.Id === 2), true);
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id > 2).All(x => x.Id === 2), false);
});
...
test('JLinq.AnyWithNullPredicate.ResetIteratorTest.1', function () {
    ...
    var query = UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 1);
...
test('JLinq.AnyWithNullPredicate.ChainTest.1', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id === 2).Any(), true);
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id === 100).Any(), false);
});
...
test('JLinq.Any.Test.1', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.Any(x => x.Id > 100), false);
});
...
test('JLinq.Any.Test.2', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.Any(x => x.Id === 2), true);
});
...
test('JLinq.Any.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).Any(x => x.Id === 2), true);
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id === 1).Any(x => x.Id === 2), false);
});
...
test('JLinq.LastWithNullPredicate.ChainTest.1', function () {
    ...
    //build this off of a query then run any items(found by user)
    var LastItemResult = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).Last();

    equal(LastItemResult.Id, 4);
    equal(LastItemResult.Txt, '4');

    //test something where we can't find any result
    LastItemResult = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1000).Last();
...
test('JLinq.Last.Test.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Last(x => x.Id === 2);
...
test('JLinq.Last.Test.2', function () {
    ...
    //go materialize the results into an array
    equal(UnitTestFramework._MutableArrayTest.Last(x => x.Id === 100), null);
});
...
test('JLinq.Last.Test.3', function () {
    ...
    //go materialize the results into an array
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Last(x => x.Id === 4);
...
test('JLinq.Last.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).Last(x => x.Id === 4);
...
test('JLinq.Min.Test.1', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Select(x => x.Id).Min(), 0);
});
...
test('JLinq.Min.ChainTest.1', function () {
    ...
    //go build the query
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).Select(x => x.Id);
...
test('JLinq.Max.Test.1', function () {
    ...
    //go materialize the results into the result
    equal(UnitTestFramework._MutableArrayTest.Select(x => x.Id).Max(), 4);
});
...
test('JLinq.Sum.Test.1', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Select(x => x.Id).Sum(), 10);
});
...
test('JLinq.Count.Test.1', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 3).Count(), 2);
});
...
test('JLinq.Count.Test.2', function () {
    ...
    //go materialize the count
    equal(UnitTestFramework._MutableArrayTest.Where(x => x.Id >= 1).Where(x => x.Id >= 3).Count(), 2);
});
...
test('JLinq.Count.Test.3', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Count(x => x.Id >= 3), 2);
});
...
test('JLinq.Count.ResetIteratorTest.1', function () {
    ...
    //we need to reset the iterator after we call this method. This test method does that.
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id > 0);
...
test('JLinq.Average.Test.1', function () {
    ...
    equal(UnitTestFramework._MutableArrayTest.Select(x => x.Id).Average(), 2);
});
...
test('JLinq.Dictionary.Number.Test.1', function () {
    ...
    var DictionaryResult = UnitTestFramework._MutableArrayTest.ToDictionary(x => x.Id);
...
test('JLinq.Dictionary.Date.Test.1', function () {
    ...
    //push the list to a dictionary
    var DictionaryResult = UnitTestFramework._MutableArrayTest.Where(x => x.CreatedDate === UnitTestFramework._FirstIndexDate).ToDictionary(x => x.CreatedDate);
...
test('JLinq.Dictionary.Boolean.Test.1', function () {
    ...
    //push the list to a dictionary
    var DictionaryResult = UnitTestFramework._MutableArrayTest.Where(x => x.CreatedDate === UnitTestFramework._FirstIndexDate).ToDictionary(x => x.IsActive);
...
test('JLinq.Dictionary.MultiKeyObject.Test.1', function () {
    ...
    //push the list to a dictionary
    var DictionaryResult = UnitTestFramework._MutableArrayTest.Where(x => x.CreatedDate === UnitTestFramework._FirstIndexDate).ToDictionary(x => { return { Id: x.Id, Active: x.IsActive }; });
...
test('JLinq.Dictionary.MultiKeyObjectWithDatePartialKey.Test.1', function () {
    ...
    //push the list to a dictionary
    var DictionaryResult = UnitTestFramework._MutableArrayTest.Take(2).ToDictionary(x => { return { Id: x.Id, Dt: x.CreatedDate }; });
...
test('JLinq.HashSet.Number.Test.1', function () {
    ...
    //just grab the ids
    var HashSetToTest = UnitTestFramework._MutableArrayTest.Select(x => x.Id).ToHashSet();
...
test('JLinq.HashSet.Date.Test.1', function () {
    ...
    //declare the hashset
    var HashSetToTest = UnitTestFramework._MutableArrayTest.Where(x => x.CreatedDate === UnitTestFramework._FirstIndexDate).Select(x => x.CreatedDate).ToHashSet();
...
test('JLinq.HashSet.MultiKeyObject.Test.1', function () {
    ...
    var SecondIdToTest = UnitTestFramework._MutableArrayTest.First(x => x.Id === 2);
    var ThirdIdToTest = UnitTestFramework._MutableArrayTest.First(x => x.Id === 3);
    var FourthIdToTest = UnitTestFramework._MutableArrayTest.First(x => x.Id === 4);

    //declare the hashset
    var HashSetToTest = new ToracTechnologies.JLinq.HashSet<UnitTestFramework.ITestObject>();

    //go build the hashset
    HashSetToTest.BuildHashSet(UnitTestFramework._MutableArrayTest.Where(x => x.Id === 2 || x.Id === 3));
    ...
    //make sure we don't have another item
    equal(HashSetToTest.ContainsItem(UnitTestFramework._MutableArrayTest.First(x => x.Id === 4)), false);
    ...
    //try to add the same item now
    equal(false, HashSetToTest.Add(UnitTestFramework._MutableArrayTest.First(x => x.Id === 2)));

    //try to add another item and make sure it was added
    equal(true, HashSetToTest.Add(UnitTestFramework._MutableArrayTest.First(x => x.Id === 4)));
...
test('JLinq.OrderBy.Asc.String.Test.CaseInsensitive', function () {
    ...
    //reset the query now
    var Results = MockData.OrderBy(x => x).ToArray();
...
test('JLinq.OrderBy.Asc.Boolean.Test.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.OrderBy(x => x.IsActive);
...
test('JLinq.OrderBy.Desc.Boolean.Test.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRunResults = UnitTestFramework._MutableArrayTest.OrderBy(x => x.IsActive).ToArray();
...
test('JLinq.OrderBy.Desc.Boolean.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRun = UnitTestFramework._MutableArrayTest.Select(x => x.IsActive).OrderBy(x => x).ToArray();
...
test('JLinq.OrderBy.Asc.Date.Test.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRun = UnitTestFramework._MutableArrayTest.OrderBy(x => x.CreatedDate).ToArray();
...
test('JLinq.OrderBy.Asc.Date.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRun = UnitTestFramework._MutableArrayTest.Select(x => x.CreatedDate).OrderBy(x => x).ToArray();
...
test('JLinq.OrderBy.Desc.Date.Test.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRun = UnitTestFramework._MutableArrayTest.OrderByDescending(x => x.CreatedDate).ToArray();
...
test('JLinq.OrderBy.Desc.Date.ChainTest.1', function () {
    ...
    //go materialize the results into an array
    var QueryToRun = UnitTestFramework._MutableArrayTest.Select(x => x.CreatedDate).OrderByDescending(x => x).ToArray();
...
test('JLinq.ElementAt.ChainTest.1', function () {
    ...
    throws(function () {
        ...
        //go run the method that should blow up
        UnitTestFramework._MutableArrayTest.Where(x => x.Id > 1).ElementAt(5);
...
test('JLinq.DefaultIfEmpty.Test.1', function () {
    ...
    //grab the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id === 1 || x.Id === 2).DefaultIfEmpty(UnitTestFramework._DefaultIfEmpty);
...
test('JLinq.DefaultIfEmpty.NoResultTest.Test.1', function () {
    ...
    //grab the query
    var QueryToRun = UnitTestFramework._MutableArrayTest.Where(x => x.Id === -1).DefaultIfEmpty(UnitTestFramework._DefaultIfEmpty);
